...
# NOTE(danielhollas): Checked into repo temporarily for debugging.
...
# DH: DEBUG
# Do not use say, because it doesn't correctly expant $@
echo "
Invoked as:
  $0 $@
...
then
  ...
  echo "DH DEBUG: Catting whole output file: $upload_file"
  #cat "$upload_file"
