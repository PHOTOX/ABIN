...
// vdw
const double vdwA = -1.329565985e+6;
const double vdwB =  3.632560798e+5;
const double vdwC = -2.147141323e+3;
const double vdwD =  1.0e+13;
const double vdwE =  13.2;
...
// polarizability
const double polarO = 0.837;
const double polarH = 0.496;
...
double ttm2f::operator()(size_t nw, const double* crd, double* grad)
{
    assert(crd != 0 || nw == 0);
